...
urlpatterns = [
    ...
    path('save-recipe-hash', GoogleOauthView.as_view({'post': 'saveRecipeHashToRedis'}), name='save-recipe-hash'),
    path('get-recipe-hashes', GoogleOauthView.as_view({'post': 'getRecipeHashesFromRedis'}), name='get-recipe-hashes'),
]
